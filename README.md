...
Spring Boot **Gradle multi-project** for **Java 11 only**.
...
implemented as **Java** + Spring Boot **2.7** (not a copy of those repositories).

## Requirements

- JDK **11** (see `.sdkmanrc`) — Gradle toolchain also targets 11
