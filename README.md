...
Spring Boot **Gradle multi-project** for **Java 25 only**.
...
implemented as **Java** + Spring Boot **3.5** (not a copy of those repositories).

## Requirements

- JDK **25** (see .sdkmanrc) — Gradle 8.x runs on JDK **21**; set JAVA_25_HOME to JDK 25 for compile/test
